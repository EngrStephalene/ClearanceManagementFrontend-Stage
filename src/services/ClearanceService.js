...
export const addClearance = (clearance) => axios.post('https://amiable-copper-production.up.railway.appamiable-copper-production.up.railway.app/api/clearance/add' , clearance)
