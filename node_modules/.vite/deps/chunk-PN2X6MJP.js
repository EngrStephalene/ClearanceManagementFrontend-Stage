import {
  ...
  useTheme
} from "./chunk-ZWUPPI2N.js";
import {
  _assertThisInitialized,
  _setPrototypeOf,
  createPopper
} from "./chunk-VL34B4AA.js";
import {
  require_react_dom
...
function useTransitionTrigger(requestEnter) {
  const [state, dispatch] = React65.useReducer(transitionStateReducer, {
    elementExited: !requestEnter,
    inProgress: false
  });
  const hasTransition = React65.useRef(false);
  const handleEntering = React65.useCallback(() => {
    dispatch("entering");
  }, []);
  const handleEntered = React65.useCallback(() => {
    dispatch("entered");
  }, []);
  const handleExiting = React65.useCallback(() => {
    dispatch("exiting");
  }, []);
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime42.jsx)(React70.Fragment, {
...
var Slider = React72.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime45.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime44.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime44.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime45.jsxs)(React72.Fragment, {
...
var _excluded35 = ["children", "className", "lastTransitionedPropertyOnEnter", "lastTransitionedPropertyOnExit", "enterClassName", "exitClassName"];
function CssTransition(props) {
  ...
  const [isEntering, setIsEntering] = React91.useState(!requestedEnter);
  React91.useEffect(() => {
    if (requestedEnter) {
...
var InputBase = React92.forwardRef(function InputBase2(inProps, ref) {
  ...
  return (0, import_jsx_runtime62.jsxs)(React92.Fragment, {
...
var Fade = React93.forwardRef(function Fade2(props, ref) {
  const theme = useTheme();
  ...
  return (0, import_jsx_runtime63.jsx)(TransitionComponent, _extends({
    ...
    children: (state, childProps) => {
      return React93.cloneElement(children2, _extends({
        style: _extends({
          opacity: 0,
...
var Button3 = React97.forwardRef(function Button4(inProps, ref) {
...
var DialogContext = React99.createContext({});
if (true) {
...
var Dialog = React100.forwardRef(function Dialog2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDialog"
  });
  ...
  const backdropClick = React100.useRef();
  const handleMouseDown = (event) => {
  ...
  const dialogContextValue = React100.useMemo(() => {
    return {
...
var DialogActions = React101.forwardRef(function DialogActions2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDialogActions"
  });
...
var DialogContent = React102.forwardRef(function DialogContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDialogContent"
  });
...
var FormHelperText = React105.forwardRef(function FormHelperText2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiFormHelperText"
  });
...
var FormLabel = React106.forwardRef(function FormLabel2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiFormLabel"
  });
...
var Grow = React107.forwardRef(function Grow2(props, ref) {
  const {
    addEndListener,
    appear = true,
    children: children2,
  ...
  const timer = React107.useRef();
  const autoTimeout = React107.useRef();
  const theme = useTheme();
  ...
  return (0, import_jsx_runtime76.jsx)(TransitionComponent, _extends({
    ...
    children: (state, childProps) => {
      return React107.cloneElement(children2, _extends({
        style: _extends({
          opacity: 0,
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-PN2X6MJP.js.map
